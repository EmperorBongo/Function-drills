...
//CODE HERE
//below the "function is called greeting its paramater is (name)
function greeting(name) {
  //The name parameter is converted to a string using String(name) and is attaching the name paramerter 
  name = String(name)
  // we are logging the name 
  console.log(`Hello ${name}`)
} 
//what is this why are we calling it out
greeting('Sam')
